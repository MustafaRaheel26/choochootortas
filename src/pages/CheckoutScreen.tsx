...
import { CreditCard, Utensils, ShoppingBag, CheckCircle2, Loader2, Home as HomeIcon } from "lucide-react";
      ...
      <div className="absolute inset-0 bg-black z-[200] flex flex-col items-center justify-center p-12 text-center">
        ...
        >
          ...
          <p className="text-xl text-white/60 font-bold uppercase tracking-widest leading-relaxed">
            Please follow the instructions on the card reader to complete your payment.
          </p>
        </motion.div>
      </div>
    );
      ...
      <div className="absolute inset-0 bg-black z-[200] flex flex-col items-center justify-center p-12 text-center">
        ...
        >
          ...
          >
            ...
            <span className="font-black uppercase tracking-widest">Return Home</span>
          </Button>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="p-8 lg:p-12 text-center border-b-[3px] border-dotted border-black/20">
              <h1 className="text-3xl lg:text-4xl font-black uppercase tracking-tighter mb-1">CHOOCHOO TORTAS</h1>
              <p className="text-[10px] font-bold text-black/40 uppercase tracking-[0.4em] mb-8">Official Order Invoice</p>
              
              <div className="bg-black text-white py-4 px-8 inline-block rounded-sm mb-6">
                <p className="text-[8px] font-black uppercase tracking-[0.5em] mb-1 opacity-50">Transaction ID</p>
                <h2 className="text-6xl lg:text-7xl font-black tracking-tighter leading-none">#{orderNumber}</h2>
              </div>

              <div className="flex flex-col items-center gap-2 mb-8">
                <p className="text-[9px] font-black uppercase tracking-[0.4em] text-black/30">Service Mode</p>
                <div className={`px-10 py-3 rounded-xl border-2 flex items-center gap-3 ${orderType === 'take-out' ? 'border-accent bg-accent/5 text-accent' : 'border-primary bg-primary/5 text-primary'}`}>
                  {orderType === 'eat-in' ? <Utensils className="w-5 h-5" /> : <ShoppingBag className="w-5 h-5" />}
            ...
            <div className="p-8 lg:p-12">
              <div className="space-y-4 mb-10">
                ...
                {cart.map((item, idx) => (
                  <div key={idx} className="flex flex-col gap-1 pb-4 border-b border-black/5 last:border-0 last:pb-0">
                    <div className="flex justify-between items-start">
                      <div className="flex gap-3">
                        <span className="font-black text-sm">{item.quantity}x</span>
                        <div>
                          <h3 className="font-black text-sm uppercase leading-tight">{item.menuItem.name}</h3>
              ...
              <div className="border-t-[3px] border-black pt-6 space-y-2">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-black/5">
                  <span className="text-xl font-black uppercase tracking-tighter">Amount Due</span>
